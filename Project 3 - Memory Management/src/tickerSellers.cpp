...
std::barrier updateTime(10,printTime);
            ...
            if(Customers.top().arrivalTime <= timeElapsed && Customers.top().processingTime == 0){
                ...
                switch(t){
                    case 'H':
                    {
                        ...
                        std::cout<<"Time: "<<timeElapsed<<" Seller "<<name<<" serving customer"<<std::endl;
                        /*
